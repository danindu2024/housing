...
const Sidebar = ({ isOpen, setIsSidebarOpen }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-slate-100 flex flex-col h-screen border-r border-slate-800 transition-transform duration-300 md:sticky md:top-0 md:h-screen md:translate-x-0 md:z-auto ${
      ...
      >
        ...
        <div className="p-6 border-b border-slate-800 flex items-center justify-between bg-slate-950">
          ...
          <button
            onClick={() => setIsSidebarOpen(false)}
            className="md:hidden p-1.5 rounded-lg text-slate-400 hover:bg-slate-800/80 hover:text-white focus:outline-none"
